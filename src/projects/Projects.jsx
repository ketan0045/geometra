...
class Projects extends React.PureComponent {
    ...
    openNewProjectDialog = () => {
        const proRow = this.state.projectRows;
        this.setState({
            projectDialogNumber: ProjectsStore.getNextProjectNumber(proRow[0].projectNumber),
            newProjectDialog: true,
        });
    };
    ...
    createNewProject = (values) => {
        this.setState({
            values: this.state.projectDialogNumber,
            newProjectDialog: true,
        });
            ...
            <div className="Projects">
                    ...
                    <div className="Toolbar">
                        ...
                        >
                            <Button
                                ...
                                onClick={() => {
                                    const rowNum = this.state.projectRows;
                                    if (!this.state.projectDialogNumber)
                                        this.setState({
                                            projectDialogNumber: ProjectsStore.getNextProjectNumber(rowNum[0].projectNumber),
                                        });
                ...
                {this.state.newProjectDialog && (
                    ...
                    >
                        ...
                        >
                            <Form.Item
                                initialValue={this.state.projectDialogNumber}
                                name="projectNumber"
                ...
                {this.state.deleteProjectDialog && (
                    <Modal
                        ...
                        width={"100%"}
                        className="Projects_DeleteModal"
                    >
                        <Table
                            style={{ overflow: "auto" }}
