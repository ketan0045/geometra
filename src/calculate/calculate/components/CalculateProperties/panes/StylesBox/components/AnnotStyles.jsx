    ...
    const onChangeValue = (value, obj) => {
        switch (obj) {
            case styles.decoration:
                {
                    annots.map((annot) => {
                        const decorationStyles = annot["fontDecoration"];
                        if (value.includes("bold")) {
                            decorationStyles["font-weight"] = "bold";
                        } else {
                            decorationStyles["font-weight"] = "normal";
                        }
                        if (value.includes("italic")) {
                            decorationStyles["font-style"] = "italic";
                        } else {
                            decorationStyles["font-style"] = "normal";
                        }
                        ...
                        decorationStyles["text-decoration"] = decorationString;
                ...
                <div className="properties-pane-row">
                    ...
                    {styles.opacity && (
                        <Input
                            ...
                            obj={styles.opacity}
                            value={(getAttributesValue(annots, styles.opacity) * 100).toFixed(0)}
                            onUpdate={onChangeValue}
                            suffix="%"
                            numbersOnly
                            textAlign="right"
