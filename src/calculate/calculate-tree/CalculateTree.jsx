...
class CalculateTree extends React.PureComponent {
    ...
    onFolderChanged = ({ key }) => {
        ...
        handleFolderChanged({
            key,
            selectedAnnotations: Immutable.fromJS(this.props.selectedAnnotations),
    ...
    renderTreeItem = (item) => {
        ...
        const isAnnotLocked = item.data.type !== "group" && this.isLocked(item);
        ...
        const calculateTreeMenu = (
            ...
            >
                ...
                <Menu.Item
                    disabled={this.isCopyHandlerButtonDisabled()}
                    onClick={() => {
                        if (this.props.selectedAnnotations.length > 0) {
                            this.setState({ showReplaceRowsConfirmation: true });
                        } else {
                            RowCopyStore.replaceAnnotationRows(this.props.selectedAnnotations);
                        }
        ...
        return (
            <>
                ...
                {this.state.showReplaceRowsConfirmation && (
                    ...
                    >
                        <ReplaceRowsDialog
                            oldData={RowCopyStore.getAllAnnotationRows(this.props.selectedAnnotations)}
