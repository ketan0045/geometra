import { ANNOTS, ANNOT_TYPES, ROWS } from "../constants";
            ...
            _.forEach(TreeStoreV2.getFolderMapping(), (folderMap) => {
                ...
                if (children) {
                    ...
                    _.forEach(bundledCurrentLevelRows, (bundledCurrentLevelRow) => {
                        ...
                        _.set(currentRow, [i18n.t(ROWS.NR_TAG)], bundledCurrentLevelRow.annotationNumber);
                        _.set(currentRow, [i18n.t(ROWS.NAME)], bundledCurrentLevelRow.annotationName);
