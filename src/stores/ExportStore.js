        ...
        if (
            ...
            if (dataWrapper.getIn(["headlineData", "exportData"])) {
                return dataWrapper.setIn(
                    ...
                    dataWrapper
                        .getIn(["headlineData", "exportData"])
                        .concat("\n" + json2csv({ data: dataWrapper.get("data"), fields: dataWrapper.get("fields") }))
                );
            }
            return dataWrapper.setIn(["headlineData", "exportData"], json2csv({ data: dataWrapper.get("data"), fields: dataWrapper.get("fields") }));
        }
    },
