...
export default createStore({
    ...
    initValueInheritance() {
        const sessionValues = JSON.parse(localStorage.getItem("inheritance"));
    ...
    changeInheritance(props) {
        ...
        localStorage.setItem(
            "inheritance",
            JSON.stringify(Object.assign({}, JSON.parse(localStorage.getItem("inheritance")), { "3DModel": this.ifcValueInheritance }))
        );
    },
