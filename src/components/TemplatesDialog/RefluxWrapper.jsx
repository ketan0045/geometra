    ...
    render() {
        ...
        return (
            <TemplatesDialog
                ...
                templateNameError={this.state.templateNameError}
                setTemplateNameError={(value) => this.setState({ templateNameError: value })}
                activeInputId={this.state.activeInputId}
                setActiveInputId={(value) => this.setState({ activeInputId: value })}
            />
        );
    }
}
